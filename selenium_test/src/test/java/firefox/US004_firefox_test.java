...
public class US004_firefox_test extends FunctionalTestFirefox {
    ...
    public void isBandLevelsPageWorkingCorrectly_TC01() {
        ...
        WebElement bandLevelPage = firefoxDriver.findElement(By.linkText("Band Levels"));
        bandLevelPage.click();
    ...
    public void isBandLevelsPageContentIsShow_TC02() {
        firefoxDriver.get(bandLevelsPageUrl);
        //Find page content
        WebElement bandLevelsContent = firefoxDriver.findElement(By.className("roles-per-band"));
    ...
    public void isBandLevelsBannerIsShow_TC03(){
        ...
        WebElement bandLevelsPageBanner = firefoxDriver.findElement(xpathPageBanner);
